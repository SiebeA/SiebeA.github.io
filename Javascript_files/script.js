...
fetch("/../Data_sourcing_files/greek_letters.txt") // fetch is a function
  ...
  .then(data => { // data is the parameter of the function which is the result of the previous function
    ...
    tipsElement.innerHTML = "<br> Requirement: <br> - The Greek language pack which will allow you to type Greek letters <br> HOWTO: windows search 'language settings' THEN 'add laguage: Greek' THEN press the hotkey 'win+spacebar' to cycle between Greek language and your other language.<br><br>";
    ...
    submitButton.addEventListener('click', function() {
      ...
      if (userInput === '') {  // If the user does not enter an answer, display a message
        ...
        var audio = new Audio("/../Data_sourcing_files/Sounds/Alphabet/" + index + ".mp3");
        audio.play();
      }
